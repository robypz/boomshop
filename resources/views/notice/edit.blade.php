                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="position" type="number" step="1"
                                        ...
                                        value="{{ $notice->position }}" required autocomplete="position" autofocus>
                            ...
                            <div class="row mb-3">
                                <div class="col-4 d-flex justify-content-start justify-content-md-end">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" name="active" value={{$notice->active}} {{ $notice->active ? 'checked' : '' }}  type="checkbox"
